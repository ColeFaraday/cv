...
\section{Awards}
% \begin{itemize}
 Best PhD Oral Presentation in Theoretical and Computational Physics at SAIP2025 Annual Conference  \hfill 2025    \\[0.5mm]
...
under a CC-BY license.
	...
	\needspace{5\baselineskip}
	\subsection{Seminars}
	\leavevmode\printbibliography[subtype=seminar, heading=none, resetnumbers=true]
	\needspace{5\baselineskip}
	\subsection{Invited Talks}
	\leavevmode\printbibliography[subtype=invited, heading=none, resetnumbers=true]
	\needspace{5\baselineskip}
...
Proceedings of the 69th Annual Conference of the South African Institute of Physics \\
ESKOM Science Expo 2025 Project Judge \\
...
\end{minipage}\\
\begin{minipage}[t]{0.8\textwidth}
	\textbf{Jack Brand}. Mentoring and helping with honours project on phenomenological energy loss at UCT
\end{minipage}\hfill
\begin{minipage}[t]{0.2\textwidth}
  \hfill 2025 -- Present 
\end{minipage}\\
